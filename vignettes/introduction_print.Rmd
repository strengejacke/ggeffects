...
out <- ggpredict(fit, c("hours_per_week", "c161sex"))

# "default" theme
print_html(out, theme = "default")
...
tt_out <- tinytable::tt(tt_out, width = 0.5)
