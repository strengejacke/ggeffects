...
For all the above examples, tables in HTML format can be created, simply by calling `print_html()`. This will create a HTML table, which can be used in R Markdown documents, for example, or in Shiny apps, or can be displayed in the viewer pane of your IDE.

You can then simply copy and paste that table into a word processor.
