...
`ggpredict()` and `ggemmeans()` compute predicted values for all possible levels or values from a model's predictors. It is recommended to read the [general introduction](marginaleffects.html) first, if you haven't done this yet.
