...
In a balanced data set, where all groups have the same number of observations, the conditional and marginal effect are identical. However, in unbalanced data, the conditional and marginal effect can differ.
