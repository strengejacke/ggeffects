...
Since average marginal effects already consider random effects by averaging over the groups, the `type`-argument is not needed when `marginalize = "empirical"` is set.
