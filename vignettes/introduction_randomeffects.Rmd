...
callout_tip(
  ...
  tags$ul(
    tags$li("Predictions can be made on the population-level or for each level of the grouping variable (unit-level). If unit-levels are requested, you need to set `type=\"random\"` and specify the grouping variable(s) in the `terms` argument."), # nolint
