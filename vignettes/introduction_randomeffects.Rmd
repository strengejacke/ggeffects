...
It is also possible to obtain predicted values by simulating from the model, where predictions are based on `simulate()`. The results come closer to _marginal predictions_ estimates.
