...
dat4 <- data.frame(
  x = dat$x[c(28, 23)],
  y = dat$predicted[c(13, 8)],
  group_col = "versicolor"
)
dat5 <- data.frame(
  x = dat$x[c(28, 54)],
  y = dat$predicted[c(13, 39)],
  group_col = "versicolor"
)
p + geom_segment(
  data = dat1,
  ...
  data = dat4,
  mapping = aes(x = x[1] - 0.05, xend = x[2], y = y[1], yend = y[2]),
  ...
  mapping = aes(x = 5.83, xend = 6.78, y = 3, yend = 3.2),
...
final comment, mention marginaleffects for more sophisticated comparisons...