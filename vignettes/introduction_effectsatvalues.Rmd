...
* `"quartiles"` calculates and uses the quartiles (lower, median and upper), _including_ minimum and maximum value.
* `"quartiles2"` calculates and uses the quartiles (lower, median and upper), _excluding_ minimum and maximum value.
