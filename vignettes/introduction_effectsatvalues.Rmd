...
The `terms`-argument not only defines the model terms (i.e. focal variables) of interest, but each model term can be limited to certain values. This allows to compute and plot adjusted predictions for (grouping) terms at specific values only, or to define values for the main effect of interest.
