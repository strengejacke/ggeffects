...
```{r}
data(efc)
fit <- lm(barthtot ~ c12hour * c172code + neg_c_7 + c161sex, data = efc)

mydf <- ggpredict(fit, terms = c("c172code", "c12hour [meansd]"))
plot(mydf)

mydf <- ggpredict(fit, terms = c("c172code", "c12hour [quart]"))
plot(mydf)
```
