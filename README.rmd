...
**And what about marginal effects?** Marginal effects refer to the difference between two adjacent predictions and indicate the derivative of the response with respect to the predictors. They are not the same as marginal means or adjusted predictions. However, calculating contrasts or pairwise comparisons with `test_predictions()` can be used to test for differences in predictions (aka marginal effects).
