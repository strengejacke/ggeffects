...
test_that("ggpredict, lm print", {
  ...
  expect_identical(
    ...
    c(
      ...
      "    170 |     23.76 | 19.17, 28.34", "", "c161sex: Female",
      ...
      "", "c161sex: Male", "neg_c_7: 8", "", "c12hour | Predicted |       95% CI",
      "----------------------------------", "      0 |     83.47 | 79.72, 87.22",
