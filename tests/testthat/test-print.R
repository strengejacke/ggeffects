...
test_that("ggpredict, print", {
  ...
  expect_equal(
    out,
    c(
      "# Predicted values of Total score BARTHEL INDEX", "", "neg_c_7: 11",
      ...
      "    170 |     76.76 | 69.96,  83.56", "", "neg_c_7: 9", "c82cop1: 1",
      "", "c12hour | Predicted |        95% CI", "-----------------------------------",
      ...
      "    170 |     81.77 | 75.20,  88.34", "", "Adjusted for:", "*   e42dep =            independent",
  ...
  expect_equal(
    out,
    c(
      "# Predicted values of Total score BARTHEL INDEX", "", "neg_c_7: 11.8",
      "c82cop1: 1", "", "c12hour | Predicted |        95% CI", "-----------------------------------",
      ...
      "    170 |     75.06 | 68.08,  82.04", "", "neg_c_7: 8", "c82cop1: 1",
      "", "c12hour | Predicted |        95% CI", "-----------------------------------",
      ...
      "    170 |     82.77 | 76.19,  89.35", "", "Adjusted for:", "*   e42dep =            independent",
      "*  c161sex =                   1.76", "* c172code = low level of education"
    ),
    ignore_attr = TRUE
  )
