...
`terms`` ``<-`` `[`data.frame`](https://rdrr.io/r/base/data.frame.html)`(`` `` c172code ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``3``, ``1``, ``3``)``,`` `` Species ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"setosa"``, ``"setosa"``, ``"versicolor"``, ``"versicolor"``)``,`` `` stringsAsFactors ``=`` ``FALSE`` ``)`` ``terms`` ``#> c172code Species`` ``#> 1 1 setosa`` ``#> 2 3 setosa`` ``#> 3 1 versicolor`` ``#> 4 3 versicolor`
...
[`library`](https://rdrr.io/r/base/library.html)`(`[`ggeffects`](https://strengejacke.github.io/ggeffects/)`)`` `[`library`](https://rdrr.io/r/base/library.html)`(`[`ggplot2`](https://ggplot2.tidyverse.org)`)`` `[`data`](https://rdrr.io/r/utils/data.html)`(``efc``, package ``=`` ``"ggeffects"``)`` ``fit`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``barthtot`` ``~`` ``c12hour`` ``+`` ``neg_c_7`` ``+`` ``c161sex`` ``+`` ``c172code``, data ``=`` ``efc``)`` `` ``mydf`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``fit``, terms ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"c12hour [30:80]"``, ``"c172code [1,3]"``)``)`` ``mydf`` ``#> # Predicted values of Total score BARTHEL INDEX`` ``#> `` ``#> c172code: low level of education`` ``#> `` ``#> c12hour | Predicted | 95% CI`` ``#> ----------------------------------`` ``#> 30 | 67.15 | 64.03, 70.26`` ``#> 38 | 65.12 | 62.05, 68.19`` ``#> 47 | 62.84 | 59.80, 65.88`` ``#> 55 | 60.81 | 57.77, 63.86`` ``#> 63 | 58.79 | 55.72, 61.86`` ``#> 80 | 54.48 | 51.28, 57.69`` ``#> `` ``#> c172code: high level of education`` ``#> `` ``#> c12hour | Predicted | 95% CI`` ``#> ----------------------------------`` ``#> 30 | 68.58 | 65.41, 71.76`` ``#> 38 | 66.56 | 63.39, 69.73`` ``#> 47 | 64.28 | 61.08, 67.48`` ``#> 55 | 62.25 | 59.00, 65.50`` ``#> 63 | 60.23 | 56.90, 63.55`` ``#> 80 | 55.92 | 52.38, 59.46`` ``#> `` ``#> Adjusted for:`` ``#> * neg_c_7 = 11.84`` ``#> * c161sex = 1.76`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``mydf``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x``, ``predicted``, colour ``=`` ``group``)``)`` ``+`` `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``)`
...
[`data`](https://rdrr.io/r/utils/data.html)`(``mtcars``)`` ``mpg_model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` `[`log`](https://rdrr.io/r/base/Log.html)`(``hp``)``, data ``=`` ``mtcars``)`` `` ``# x-values and predictions based on the full range of the original "hp"-values`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``mpg_model``, ``"hp"``)`` ``#> # Predicted values of mpg`` ``#> `` ``#> hp | Predicted | 95% CI`` ``#> ------------------------------`` ``#> 50 | 30.53 | 27.84, 33.22`` ``#> 85 | 24.82 | 23.21, 26.42`` ``#> 120 | 21.11 | 19.91, 22.30`` ``#> 155 | 18.35 | 17.11, 19.59`` ``#> 195 | 15.88 | 14.36, 17.41`` ``#> 230 | 14.10 | 12.29, 15.92`` ``#> 265 | 12.58 | 10.48, 14.68`` ``#> 335 | 10.06 | 7.45, 12.66`` `` ``# x-values and predictions based on "hp"-values ranging from 50 to 150`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``mpg_model``, ``"hp [50:150]"``)`` ``#> # Predicted values of mpg`` ``#> `` ``#> hp | Predicted | 95% CI`` ``#> ------------------------------`` ``#> 50 | 30.53 | 27.84, 33.22`` ``#> 63 | 28.04 | 25.86, 30.23`` ``#> 75 | 26.17 | 24.33, 28.00`` ``#> 87 | 24.57 | 23.00, 26.13`` ``#> 100 | 23.07 | 21.71, 24.43`` ``#> 113 | 21.75 | 20.52, 22.99`` ``#> 125 | 20.67 | 19.49, 21.84`` ``#> 150 | 18.71 | 17.49, 19.92`
...
[`data`](https://rdrr.io/r/utils/data.html)`(``efc``, package ``=`` ``"ggeffects"``)`` ``# short variable label, for plot`` `[`attr`](https://rdrr.io/r/base/attr.html)`(``efc``$``c12hour``, ``"label"``)`` ``<-`` ``"hours of care"`` ``fit`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``barthtot`` ``~`` ``c12hour`` ``*`` ``c161sex`` ``+`` ``neg_c_7``, data ``=`` ``efc``)`` `` ``mydf`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``fit``, terms ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"c161sex"``, ``"c12hour [meansd]"``)``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``mydf``)`

![](introduction_effectsatvalues_files/figure-html/unnamed-chunk-7-1.png)

` ``mydf`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``fit``, terms ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"c161sex"``, ``"c12hour [quartiles]"``)``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``mydf``)`
...
`# x-values and predictions based on "hp"-values, multiplied by 2`` ``hp_double`` ``<-`` ``function``(``x``)`` ``2`` ``*`` ``x`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``mpg_model``, ``"hp [hp_double]"``)`` ``#> # Predicted values of mpg`` ``#> `` ``#> hp | Predicted | 95% CI`` ``#> ---------------------------------`` ``#> 104.00 | 22.65 | 21.34, 23.96`` ``#> 132.00 | 20.08 | 18.91, 21.25`` ``#> 186.00 | 16.39 | 14.94, 17.84`` ``#> 210.00 | 15.08 | 13.43, 16.73`` ``#> 226.00 | 14.29 | 12.51, 16.08`` ``#> 300.00 | 11.24 | 8.88, 13.61`` ``#> 410.00 | 7.88 | 4.81, 10.95`` ``#> 670.00 | 2.59 | -1.63, 6.82`
...
`val`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``100``, ``200``, ``300``)`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``mpg_model``, ``"hp [val]"``)`` ``#> # Predicted values of mpg`` ``#> `` ``#> hp | Predicted | 95% CI`` ``#> ------------------------------`` ``#> 100 | 23.07 | 21.71, 24.43`` ``#> 200 | 15.61 | 14.04, 17.17`` ``#> 300 | 11.24 | 8.88, 13.61`
...
[`library`](https://rdrr.io/r/base/library.html)`(`[`datawizard`](https://easystats.github.io/datawizard/)`)`` `[`library`](https://rdrr.io/r/base/library.html)`(`[`lme4`](https://github.com/lme4/lme4/)`)`` `[`data`](https://rdrr.io/r/utils/data.html)`(``efc``, package ``=`` ``"ggeffects"``)`` `` ``efc``$``c12hour`` ``<-`` `[`standardize`](https://easystats.github.io/datawizard/reference/standardize.html)`(``efc``$``c12hour``)`` ``efc``$``e15relat`` ``<-`` `[`to_factor`](https://easystats.github.io/datawizard/reference/to_factor.html)`(``efc``$``e15relat``)`` `` ``m`` ``<-`` `[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(`` `` ``barthtot`` ``~`` ``c12hour`` ``+`` `[`I`](https://rdrr.io/r/base/AsIs.html)`(``c12hour``^``2``)`` ``+`` ``neg_c_7`` ``+`` ``c160age`` ``+`` ``c172code`` ``+`` ``(``1`` ``|`` ``e15relat``)``,`` `` data ``=`` ``efc`` ``)`` `` ``me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` ``"c12hour"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`
...
`me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` ``"c12hour [all]"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`
...
`me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` ``"c12hour [n=2]"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`

![](introduction_effectsatvalues_files/figure-html/unnamed-chunk-12-1.png)

`me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` ``"c12hour [n=10]"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`
...
[`data`](https://rdrr.io/r/utils/data.html)`(``mtcars``)`` ``mpg_model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` `[`log`](https://rdrr.io/r/base/Log.html)`(``hp``)`` ``+`` ``disp``, data ``=`` ``mtcars``)`` `` ``# "disp" is hold constant at its mean`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``mpg_model``, ``"hp"``)`` ``#> # Predicted values of mpg`` ``#> `` ``#> hp | Predicted | 95% CI`` ``#> ------------------------------`` ``#> 50 | 25.84 | 21.86, 29.82`` ``#> 85 | 22.70 | 20.67, 24.72`` ``#> 120 | 20.65 | 19.55, 21.76`` ``#> 155 | 19.13 | 17.91, 20.35`` ``#> 195 | 17.77 | 15.91, 19.64`` ``#> 230 | 16.79 | 14.36, 19.23`` ``#> 265 | 15.95 | 13.00, 18.91`` ``#> 335 | 14.56 | 10.73, 18.40`` ``#> `` ``#> Adjusted for:`` ``#> * disp = 230.72`` `` ``# "disp" is hold constant at value 200`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``mpg_model``, ``"hp"``, condition ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``disp ``=`` ``200``)``)`` ``#> # Predicted values of mpg`` ``#> `` ``#> hp | Predicted | 95% CI`` ``#> ------------------------------`` ``#> 50 | 26.53 | 22.91, 30.15`` ``#> 85 | 23.38 | 21.66, 25.11`` ``#> 120 | 21.34 | 20.27, 22.41`` ``#> 155 | 19.82 | 18.34, 21.30`` ``#> 195 | 18.46 | 16.25, 20.67`` ``#> 230 | 17.48 | 14.68, 20.28`` ``#> 265 | 16.64 | 13.31, 19.97`` ``#> 335 | 15.25 | 11.03, 19.47`
...
[`library`](https://rdrr.io/r/base/library.html)`(`[`lme4`](https://github.com/lme4/lme4/)`)`` `[`data`](https://rdrr.io/r/utils/data.html)`(``efc``, package ``=`` ``"ggeffects"``)`` ``efc``$``e15relat`` ``<-`` `[`to_factor`](https://easystats.github.io/datawizard/reference/to_factor.html)`(``efc``$``e15relat``)`` ``m`` ``<-`` `[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(``neg_c_7`` ``~`` ``c12hour`` ``+`` ``c160age`` ``+`` ``c161sex`` ``+`` ``(``1`` ``|`` ``e15relat``)``, data ``=`` ``efc``)`` ``me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` ``"c12hour"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`
...
`me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"c12hour"``, ``"e15relat"``)``, type ``=`` ``"random"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`
...
`me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"c12hour"``, ``"e15relat [child,sibling]"``)``, type ``=`` ``"random"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`
...
[`data`](https://rdrr.io/r/utils/data.html)`(``"sleepstudy"``)`` ``m`` ``<-`` `[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(``Reaction`` ``~`` ``Days`` ``+`` ``(``1`` ``+`` ``Days`` ``|`` ``Subject``)``, data ``=`` ``sleepstudy``)`` ``me`` ``<-`` `[`predict_response`](https://strengejacke.github.io/ggeffects/reference/predict_response.md)`(``m``, terms ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Days"``, ``"Subject [sample=8]"``)``, type ``=`` ``"random"``)`` `[`plot`](https://strengejacke.github.io/ggeffects/reference/plot.md)`(``me``)`
