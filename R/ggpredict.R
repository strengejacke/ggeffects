...
#'   svyglm.nb, truncreg, coxph, stanreg, brmsfit, lmRob, glmRob, brglm}.
...
#'   \code{terms = "age [meansd]"} would return predictions for the value
#'   which is one standard-deviation below the mean age, the mean age and
