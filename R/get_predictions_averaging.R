...
#' @export
get_predictions.betareg <- get_predictions.averaging

#' @export
get_predictions.truncreg <- get_predictions.averaging

#' @export
get_predictions.ivreg <- get_predictions.averaging

#' @export
get_predictions.vgam <- get_predictions.averaging

#' @export
get_predictions.fixest <- get_predictions.averaging

#' @export
get_predictions.feglm <- get_predictions.averaging

#' @export
get_predictions.glmx <- get_predictions.averaging

#' @export
get_predictions.phylolm <- get_predictions.averaging

#' @export
get_predictions.phyloglm <- get_predictions.averaging
